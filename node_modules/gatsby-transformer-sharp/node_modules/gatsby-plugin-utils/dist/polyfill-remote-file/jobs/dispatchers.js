...
function dispatchLocalFileServiceJob({
  ...
  var _publicUrl$pop, _global$__GATSBY;
  ...
  const outputFilename = (_publicUrl$pop = publicUrl.pop()) === null || _publicUrl$pop === void 0 ? void 0 : _publicUrl$pop.split(`?`)[0];
...
function dispatchLocalImageServiceJob({
  ...
  var _publicUrl$pop2, _global$__GATSBY2;
  ...
  const outputFilename = (_publicUrl$pop2 = publicUrl.pop()) === null || _publicUrl$pop2 === void 0 ? void 0 : _publicUrl$pop2.split(`?`)[0];
  const httpHeaders = (0, _getRequestHeadersForUrl.getRequestHeadersForUrl)(url, store);
  actions.createJobV2({
    name: `IMAGE_CDN`,
    inputPaths: [],
