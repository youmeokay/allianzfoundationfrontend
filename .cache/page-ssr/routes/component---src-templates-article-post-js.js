...
__webpack_require__.d(__webpack_exports__, {
  "Z": () => (/* binding */ blocks_renderer)
});

// EXTERNAL MODULE: external "/Volumes/ymoHD/localhost/allianz-foundation/@new/allianzfoundation/frontend/node_modules/react/index.js"
var index_js_ = __webpack_require__(19);
var index_js_default = /*#__PURE__*/__webpack_require__.n(index_js_);
;// CONCATENATED MODULE: ./src/components/block-rich-text.js
const BlockRichText=({data})=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"prose mx-auto py-8"},/*#__PURE__*/index_js_default().createElement("div",{dangerouslySetInnerHTML:{__html:data.body}}),"hello");};/* harmony default export */ const block_rich_text = (BlockRichText);
;// CONCATENATED MODULE: ./src/components/blocks-renderer.js
const componentsMap={StrapiComponentSharedRichText:block_rich_text};const Block=({block})=>{const Component=componentsMap[block.__typename];if(!Component){return null;}return/*#__PURE__*/index_js_default().createElement(Component,{data:block});};const BlocksRenderer=({blocks})=>{return/*#__PURE__*/index_js_default().createElement("div",null,blocks.map((block,index)=>/*#__PURE__*/index_js_default().createElement(Block,{key:`${index}${block.__typename}`,block:block})));};const query="1743586470";/* harmony default export */ const blocks_renderer = (BlocksRenderer);
...
const Seo=({seo={}})=>{const{strapiGlobal}=(0,gatsby_browser_entry.useStaticQuery)("3820491937");const{siteName,defaultSeo,favicon}=strapiGlobal;// Merge default and page-specific SEO values
const fullSeo={...defaultSeo,...seo};// Add site name to title
fullSeo.metaTitle=`${fullSeo.metaTitle} | ${siteName}`;const getMetaTags=()=>{const tags=[];if(fullSeo.metaTitle){tags.push({property:"og:title",content:fullSeo.metaTitle},{name:"twitter:title",content:fullSeo.metaTitle});}if(fullSeo.metaDescription){tags.push({name:"description",content:fullSeo.metaDescription},{property:"og:description",content:fullSeo.metaDescription},{name:"twitter:description",content:fullSeo.metaDescription});}if(fullSeo.shareImage){const imageUrl=fullSeo.shareImage.file.url;tags.push({name:"image",content:imageUrl},{property:"og:image",content:imageUrl},{name:"twitter:image",content:imageUrl});}if(fullSeo.article){tags.push({property:"og:type",content:"article"});}tags.push({name:"twitter:card",content:"summary_large_image"});return tags;};const metaTags=getMetaTags();return/*#__PURE__*/index_js_default().createElement(HelmetExport,{title:fullSeo.metaTitle,link:[{rel:"icon",href:favicon.file.url}],meta:metaTags});};/* harmony default export */ const seo = (Seo);
...
/* harmony import */ var _components_layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5400);
/* harmony import */ var _components_blocks_renderer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1086);
/* harmony import */ var _components_seo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8183);
const ArticlePage=({data})=>{const article=data.strapiArticle;const seo={metaTitle:article.title,metaDescription:article.description};return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z,{as:"article"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_seo__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z,{seo:seo}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("header",{className:"container max-w-4xl py-8"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"text-6xl font-bold text-neutral-700"},article.title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"mt-4 text-2xl text-neutral-500"},article.description)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main",{className:"mt-8"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_blocks_renderer__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,{blocks:article.blocks||[]})));};const pageQuery="2926687843";/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ArticlePage);
