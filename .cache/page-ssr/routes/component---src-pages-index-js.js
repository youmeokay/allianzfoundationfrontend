...
const ArticleCard=({article})=>{return/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:`/article/${article.slug}`,className:"overflow-hidden rounded-lg bg-white shadow-sm transition-shadow hover:shadow-md"},/*#__PURE__*/index_js_default().createElement("div",{className:"px-4 py-4"},/*#__PURE__*/index_js_default().createElement("h3",{className:"font-bold text-neutral-700"},article.title),/*#__PURE__*/index_js_default().createElement("p",{className:"line-clamp-2 mt-2 text-neutral-500"},article.description)));};const query="3612436166";/* harmony default export */ const article_card = (ArticleCard);
