...
const componentsMap = {
  StrapiComponentSharedRichText: _block_rich_text__WEBPACK_IMPORTED_MODULE_1__["default"]
};
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _public_page_data_sq_d_3820491937_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../public/page-data/sq/d/3820491937.json */ "./public/page-data/sq/d/3820491937.json");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
...
const Seo = ({
  ...
  const {
    strapiGlobal
  } = _public_page_data_sq_d_3820491937_json__WEBPACK_IMPORTED_MODULE_0__.data;
  const {
    siteName,
    defaultSeo,
    favicon
  ...
  const getMetaTags = () => {
    ...
    if (fullSeo.shareImage) {
      const imageUrl = fullSeo.shareImage.file.url;
      tags.push({
        name: "image",
        content: imageUrl
      }, {
...
"use strict";
module.exports = JSON.parse('{"data":{"strapiAbout":{"title":"About the strapi blog","blocks":[{"__typename":"StrapiComponentSharedRichText","body":"<h1>## Dedit imago conspicuus cum capillis totidem inhibere Lorem markdownum **rerum**, est limine: columbas: ab infelix hostem arbore nudis crudelis. Videtur reliquit ambo ferrum dote sub amne fatis **illuc**, in magis, nec.</h1>"}]}}}');

/***/ }),

/***/ "./public/page-data/sq/d/3820491937.json":
/*!***********************************************!*\
  !*** ./public/page-data/sq/d/3820491937.json ***!
  \***********************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"data":{"strapiGlobal":{"siteName":"Strapi Blog","favicon":{"file":{"url":"http://localhost:1337/uploads/favicon_f066672ed5.png"}},"defaultSeo":{"metaTitle":"Page","metaDescription":"A blog made with Strapi","shareImage":{"file":{"url":"http://localhost:1337/uploads/default_image_39493d2338.png"}}}}}}');
