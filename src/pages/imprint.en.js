...
const ImprintPage = ({ data }) => {
  ...
  const imprint = data.strapiImprint
  const modules = data.strapiImprint.modules

  const seo = {
    metaTitle: imprint.title,
    metaDescription: imprint.description,
  }
      ...
      <header className={`main header ${
          ...
          <nav className="language">
            <ul className="menu simple language-selector">
              {imprint.localizations.map((imprint) => (
                <li>
                  <Link to="/de/imprint" target="_self" className="lang-link">DE</Link>
                </li>
              ))}
            </ul>
          </nav>
