...
const ContactPage = ({ data }) => {
  ...
  const modules = data.strapiContact.modules

  const seo = {
    metaTitle: contact.title,
      ...
      <header className={`main header ${
          ...
          <nav className="language">
            <ul className="menu simple language-selector">
              {contact.localizations.map((contact) => (
                <li>
                  <Link to="/de/contact" target="_self" className="lang-link">DE</Link>
                </li>
              ))}
            </ul>
          </nav>
