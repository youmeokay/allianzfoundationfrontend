...
const PrivacyPage = ({ data }) => {
  ...
  const privacy = data.strapiPrivacy
  const modules = data.strapiPrivacy.modules

  const seo = {
    metaTitle: privacy.title,
      ...
      <header className={`main header ${
          ...
          <nav className="language">
            <ul className="menu simple language-selector">
              {privacy.localizations.map((privacy) => (
                <li>
                  <Link to="/de/privacy" target="_self" className="lang-link">DE</Link>
                </li>
              ))}
            </ul>
          </nav>
