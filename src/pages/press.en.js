...
const PressPage = ({ data }) => {
  ...
  const press = data.strapiPresse
  const modules = data.strapiPresse.modules

  const seo = {
    metaTitle: press.title,
    metaDescription: press.description,
  }
      ...
      <header className={`main header ${
          ...
          <nav className="language">
            <ul className="menu simple language-selector">
              {press.localizations.map((press) => (
                <li>
                  <Link to="/de/press" target="_self" className="lang-link">DE</Link>
                </li>
              ))}
            </ul>
          </nav>
