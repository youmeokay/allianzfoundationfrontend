...
const NewsletterPage = ({ data }) => {
  ...
  const newsletter = data.strapiNewsletter
  const modules = data.strapiNewsletter.modules

  const seo = {
    metaTitle: newsletter.title,
    metaDescription: newsletter.description,
  }
      ...
      <header className={`main header ${
          ...
          <nav className="language">
            <ul className="menu simple language-selector">
              {newsletter.localizations.map((newsletter) => (
                <li>
                  <Link to="/de/newsletter" target="_self" className="lang-link">DE</Link>
                </li>
              ))}
            </ul>
          </nav>
