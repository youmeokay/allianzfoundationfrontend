	...
	*/
	...
	function CursorCore({
	  ...
	  clickables = ['.list-card', '.link-list a', '.calendar-card-list', '.deactivated', '.highlight-the-hamburger', '.html-content a', '.readmore-toggle', '.articleDesc a', '.topic-nav a', '.search-icon', '.logo-link', '.menu a', '.button', '.accordeon', 'input[type="text"]', 'input[type="email"]', 'input[type="number"]', 'input[type="submit"]', 'input[type="search"]', 'input[type="image"]', 'label[for]', 'select', 'textarea', 'button'],
		...
		fullscreenclickables = ['.post-media.fullScreen'],
		readmoreclickables = ['.readmore-toggle'],
		readlessclickables = ['.readless-toggle'],
		logoclickables = ['.text-logo']
	}) {
	  ...
	  useEventListener('mouseout', onMouseLeaveViewport); // Cursors Hover/Active State
		...
		React.useEffect(() => {
	    if (isActive) {
				cursorInnerRef.current.classList.add('open');
	      ...
	      cursorOuterRef.current.style.transform = `translate(-50%, -50%) scale(${outerScale})`;
				...
				cursorInnerRef.current.classList.remove('open');
	  ...
	  React.useEffect(() => {
	    if (isActiveClickable) {
	      cursorInnerRef.current.style.transform = `translate(-50%, -50%) scale(${innerScale * 1})`;
	      cursorOuterRef.current.style.transform = `translate(-50%, -50%) scale(${outerScale * 1})`;
	    }
	  ...
	  React.useEffect(() => {
		...
		React.useEffect(() => {
	    const imageclickableEls = document.querySelectorAll(imageclickables.join(','));
	    imageclickableEls.forEach(el => {
	      el.style.cursor = 'none';
	      el.addEventListener('mouseover', () => {
					cursorInnerRef.current.classList.add('open-on-image');
	      });
	      el.addEventListener('click', () => {
	        setIsActiveClickable(false);
	      });
	      ...
	      el.addEventListener('mouseout', () => {
					cursorInnerRef.current.classList.remove('open-on-image');
	      });
	    });
	    return () => {
	      imageclickableEls.forEach(el => {
	  ...
	  }, [isActive, imageclickables]); // Cursor Styles

		React.useEffect(() => {
	    const fullscreenclickableEls = document.querySelectorAll(fullscreenclickables.join(','));
	    fullscreenclickableEls.forEach(el => {
	      el.style.cursor = 'none';
	      el.addEventListener('mouseover', () => {
					cursorInnerRef.current.classList.add('open-on-fullscreen');
	      });
	      el.addEventListener('click', () => {
	        setIsActiveClickable(false);
	      });
	      ...
	      el.addEventListener('mouseout', () => {
					cursorInnerRef.current.classList.remove('open-on-fullscreen');
	      });
	    });
	    return () => {
	      fullscreenclickableEls.forEach(el => {
	  ...
	  }, [isActive, fullscreenclickables]); // Cursor Styles

		React.useEffect(() => {
	    const readmoreclickableEls = document.querySelectorAll(readmoreclickables.join(','));
	    readmoreclickableEls.forEach(el => {
	      el.style.cursor = 'none';
	      el.addEventListener('mouseover', () => {
					cursorInnerRef.current.classList.add('open-on-readmore');
	      });
	      el.addEventListener('click', () => {
	        setIsActiveClickable(false);
	      });
	      ...
	      el.addEventListener('mouseout', () => {
					cursorInnerRef.current.classList.remove('open-on-readmore');
	      });
	    });
	    return () => {
	      readmoreclickableEls.forEach(el => {
	  ...
	  }, [isActive, readmoreclickables]); // Cursor Styles

		React.useEffect(() => {
	    const readlessclickableEls = document.querySelectorAll(readlessclickables.join(','));
	    readlessclickableEls.forEach(el => {
	      el.style.cursor = 'none';
	      el.addEventListener('mouseover', () => {
					cursorInnerRef.current.classList.add('open-on-readless');
	      });
	      el.addEventListener('click', () => {
	        setIsActiveClickable(false);
	      });
	      ...
	      el.addEventListener('mouseout', () => {
					cursorInnerRef.current.classList.remove('open-on-readless');
	      });
	    });
	    return () => {
	      readlessclickableEls.forEach(el => {
	  ...
	  }, [isActive, readlessclickables]); // Cursor Styles

		React.useEffect(() => {
	    const logoclickableEls = document.querySelectorAll(logoclickables.join(','));
	    logoclickableEls.forEach(el => {
	      el.style.cursor = 'none';
	      el.addEventListener('mouseover', () => {
					cursorInnerRef.current.classList.add('open-on-logo');
	      });
	      el.addEventListener('click', () => {
	        setIsActiveClickable(false);
	      });
	      ...
	      el.addEventListener('mouseout', () => {
					cursorInnerRef.current.classList.remove('open-on-logo');
	      });
	    });
	    return () => {
	      logoclickableEls.forEach(el => {
	  ...
	  }, [isActive, logoclickables]); // Cursor Styles

		React.useEffect(() => {
	    const carouselclickablesnextEls = document.querySelectorAll(carouselclickablesnext.join(','));
	    carouselclickablesnextEls.forEach(el => {
	      el.style.cursor = 'none';
	      el.addEventListener('mouseover', () => {
					cursorInnerRef.current.classList.add('open-on-carousel-next');
					cursorInnerRef.current.classList.remove('open-on-carousel-prev');
	      });
	      el.addEventListener('click', () => {
	        setIsActiveClickable(false);
	      });
	      ...
	      el.addEventListener('mouseout', () => {
					cursorInnerRef.current.classList.remove('open-on-carousel-next');
	      });
	    });
	    return () => {
	      carouselclickablesnextEls.forEach(el => {
	  ...
	  }, [isActive, carouselclickablesnext]); // Cursor Styles

		React.useEffect(() => {
	    const carouselclickableprevEls = document.querySelectorAll(carouselclickablesprev.join(','));
	    carouselclickableprevEls.forEach(el => {
	      el.style.cursor = 'none';
	      el.addEventListener('mouseover', () => {
					cursorInnerRef.current.classList.add('open-on-carousel-prev');
					cursorInnerRef.current.classList.remove('open-on-carousel-next');
	      });
	      el.addEventListener('click', () => {
	        setIsActiveClickable(false);
	  ...
	  }, [isActive, carouselclickablesprev]); // Cursor Styles
	  ...
	  const styles = {
		...
		const createMarkup = '<div class="cursor"></div>';
