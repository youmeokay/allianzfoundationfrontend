...
function Hamburger() {
  return (
    <section className="hamburger-menu">
      ...
      <div className="hamburger-meta-menu">
        <div className="grid-container full">
          <div className="grid-x">
            <div className="cell small-7">
              <ul className="menu hamburger-link-alt">
                <li>
            ...
            <div className="cell small-5">
              <ul className="menu socialmedia hamburger-link-alt align-right">
                <li>
                  <Link to="/de/">
